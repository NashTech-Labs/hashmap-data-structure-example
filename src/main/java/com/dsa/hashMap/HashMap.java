...
public class HashMap {
    ...
    /**
     * method HashMap used for initialized bucket
     * @param hashSize maximum size of hashMap
     */
    ...
    public static class LinkedList {
        ...
        /**
         * method used for display values in hashMap
         * @param n numbers of node
         * @return return key value if below condition true.
         */
